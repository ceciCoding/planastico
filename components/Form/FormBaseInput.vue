      ...
      <input
        ...
        :class="[
          `form-base-input__input--${props.field.roundedCorner}`,
          {
            ...
            'form-base-input__input--has-trailing-icon': props.field.isCurrency || props.field.isErasable
          }
        ]"
        :type="props.field.inputType"
        :placeholder="props.field.placeholder"
        @input="(e) => emit('update:model-value', e.target.value)">
      <span v-if="props.field.isCurrency" class="form-base-input__currency">
        €
      </span>
    </div>
    <span v-if="props.field.maxLength && !props.error.length" class="form-base-input__count">
